...
def GeneratePspRequest(processorList, processorName, platformName, baseBIOSType, revision, operationType, purpose, newName, token):
...
def main():
  ...
  requestId = GeneratePspRequest(processorList, processorName, platformName, baseBIOSType, revision, operationType, purpose, newName, token)
  if not requestId:
    return
  #Remove " in requestId
